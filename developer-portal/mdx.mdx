...
With Samples Panel:
```html
<RedocResponse definitionId="warrantycheck" pointer="#/components/responses/PetResponse" />
```
<RedocResponse definitionId="warrantycheck" pointer="#/components/responses/PetResponse" />
...
```html
<RedocResponse definitionId="warrantycheck" pointer="#/components/responses/PetResponse" hideSamples={true} />
```
<RedocResponse definitionId="warrantycheck" pointer="#/components/responses/PetResponse" hideSamples={true} />
